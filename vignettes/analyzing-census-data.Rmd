...
Data Commons is part of Google.org's philanthropic initiatives, designed to democratize access to public data by combining datasets from organizations like the UN, World Bank, and U.S. Census into a unified knowledge graph.
...
sprintf("Pre-2020 growth rate: %.2f%%", growth_rate$pre_2020_growth)
sprintf("Post-2020 growth rate: %.2f%%", growth_rate$post_2020_growth)

# Note for statistics enthusiasts: We're using arithmetic mean here for simplicity.
# For compound growth rates, geometric mean would be more precise:
# geometric_mean_growth = (last_value/first_value)^(1/n_years) - 1
