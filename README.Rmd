...
> :bulb: A detailed walkthrough of census data analysis using `datacommons` is available in the corresponding [vignette](https://tidy-intelligence.github.io/r-datacommons/articles/analyzing-census-data.html).
