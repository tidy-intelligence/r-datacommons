...
Get a free API key for Data Commons [here](https://apikeys.datacommons.org/). Set the Data Commons API key as the `DATACOMMONS_API_KEY` environment variable using the helper function and restart your R session to load the key:
